...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		NoteEntity n2 = new NoteEntity(null,ZonedDateTime.parse("2023-08-28T11:30:00Z"),120.0,"Abastecimento do carro","Abastecimento de 40 Litros de gasolina");
		NoteEntity n3 = new NoteEntity(null,ZonedDateTime.parse("2023-08-27T14:00:00Z"),50.0,"Peças","Compra de peças para conserto de um eletronico");
		NoteEntity n4 = new NoteEntity(null,ZonedDateTime.parse("2023-08-31T20:30:00Z"),4350.0,"Hardware","Compra de peças de computador");
		NoteEntity n5 = new NoteEntity(null,ZonedDateTime.parse("2023-08-27T20:00:00Z"),110.0,"Conta de energia","Pagamento da conta de energia");
